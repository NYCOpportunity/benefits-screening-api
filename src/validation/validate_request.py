...
def validate_request(request: Dict) -> Tuple[bool, EligibilityRequest, Union[str, List[str]]]:
    """    
    Args:
    ...
    """
    try:
        eligibility_request = EligibilityRequest(**request)
        return True, eligibility_request, "Validation successful"
